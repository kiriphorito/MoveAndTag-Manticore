...
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (8.066826245961662,-0.41867583515492957)
...
print "     Node 1 and 2 of 4"
path += rrtpath(obstacleList,start,goal,rand)
start = (8.49900358954497,-3.6053773301873124)
...
print "     Node 3 and 4 of 5"
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (4.227850530054603,3.31820378019746)
...
print "     Node 3 and 4 of 6"
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (3.1397298583073994,-4.728580981608678)
...
print "     Node 2 and 3 of 4"
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (7.017943495739932,4.022170007193405)
...
print "     Node 4 and 5 of 8"
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (0.1974869683716145,2.3868385454520267)
...
print "     Node 2 and 3 of 4"
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (9.565582506620045,-5.976176349447453)
...
pathStr = pathStr.replace("]", ")")
content += pathStr
print "Path 28 of 108"
path = []
start = (6.088862984580276,-3.764665016360451)
goal = (5.981194846061758,-4.930628751205559)
print "     Node 1 and 2 of 3"
path += rrtpath(obstacleList,start,goal,rand)
start = (5.981194846061758,-4.930628751205559)
...
pathStr = pathStr.replace("]", ")")
content += pathStr
print "Path 41 of 108"
path = []
start = (5.575855873895353,2.5639794481482037)
goal = (6.306564046653541,5.755608117821889)
print "     Node 1 and 2 of 3"
path += rrtpath(obstacleList,start,goal,rand)
start = (6.306564046653541,5.755608117821889)
...
pathStr = pathStr.replace("]", ")")
content += pathStr
print "Path 43 of 108"
path = []
start = (2.8983961282358752,0.7410131240841489)
goal = (2.61500199018667,1.4696556476263458)
print "     Node 1 and 2 of 6"
path += rrtpath(obstacleList,start,goal,rand)
start = (2.61500199018667,1.4696556476263458)
...
print "     Node 4 and 5 of 6"
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (-4.1992088163271495,3.85247175021414)
...
print "     Node 4 and 5 of 6"
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (-3.7881278315423432,-3.620181836529433)
...
pathStr = pathStr.replace("]", ")")
content += pathStr
print "Path 50 of 108"
path = []
start = (3.0532985719132686,-2.767902401144351)
goal = (-1.180585326237309,-2.15962191496938)
print "     Node 1 and 2 of 3"
path += rrtpath(obstacleList,start,goal,rand)
start = (-1.180585326237309,-2.15962191496938)
...
print "     Node 3 and 4 of 6"
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (0.17131346587098317,4.380332148520767)
...
pathStr = pathStr.replace("]", ")")
content += pathStr
print "Path 59 of 108"
path = []
start = (3.6724605940118895,3.61976793911425)
goal = (2.566230873447509,5.087326864836272)
print "     Node 1 and 2 of 3"
path += rrtpath(obstacleList,start,goal,rand)
start = (2.566230873447509,5.087326864836272)
...
pathStr = pathStr.replace("]", ")")
content += pathStr
print "Path 60 of 108"
path = []
start = (10.254264731120065,2.0528794818643883)
goal = (10.995144772023883,4.9023504375310525)
print "     Node 1 and 2 of 3"
path += rrtpath(obstacleList,start,goal,rand)
start = (10.995144772023883,4.9023504375310525)
...
pathStr = pathStr.replace("]", ")")
content += pathStr
print "Path 68 of 108"
path = []
start = (3.3335933050136752,4.378690266808094)
goal = (-0.49020831967118106,5.802814448980812)
print "     Node 1 and 2 of 3"
path += rrtpath(obstacleList,start,goal,rand)
start = (-0.49020831967118106,5.802814448980812)
...
print "     Node 2 and 3 of 4"
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (-2.2887630848087523,-3.821821089174517)
...
pathStr = pathStr.replace("]", ")")
content += pathStr
print "Path 72 of 108"
path = []
start = (0.6063713245488254,-0.5632168905704589)
goal = (-1.9539999913261648,-0.9100419141603222)
print "     Node 1 and 2 of 5"
path += rrtpath(obstacleList,start,goal,rand)
start = (-1.9539999913261648,-0.9100419141603222)
...
print "     Node 3 and 4 of 5"
path += rrtpath(obstacleList,start,goal,rand)[1:]
start = (-6.312612466887127,-1.19617570697935)
...
pathStr = pathStr.replace("]", ")")
content += pathStr
print "Path 83 of 108"
path = []
start = (0.17131346587098317,4.380332148520767)
goal = (-0.2157452062202525,4.784079311227253)
print "     Node 1 and 2 of 3"
path += rrtpath(obstacleList,start,goal,rand)
start = (-0.2157452062202525,4.784079311227253)
